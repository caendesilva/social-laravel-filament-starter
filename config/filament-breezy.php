...
return [
    ...
    */
    ...
    | NOTE: if enable_profile_page => false then this value is ignored, and you'll need to register the item in your service provider manually.
    */
    ...
    | NOTE: if enable_profile_page => false then this value is ignored.
    */
    ...
    */
    ...
    | Rules for required and confirmed are already set. These rules will apply to the My Profile, registration, and password reset forms.
    | To use an instance of the \Illuminate\Validation\Rules\Password::class, see documentation.
    */
    ...
    */
    ...
    /*
    |--------------------------------------------------------------------------
    | Set a route name prefix for all of Breezy's auth routes.
    | Ex. set filament. to prefix all route names, filament.register.
    | WARNING: if you use a custom route prefix, you'll need to override the default auth routes used throughout your application.
    | This is outside of Breezy's scope and will be up to the dev to maintain. Use at your own risk.
